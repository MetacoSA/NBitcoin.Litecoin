...
namespace NBitcoin.Litecoin
{
	...
	Tuple.Create(new byte[]{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0xff,0x42,0xb2,0xb6,0x23}, 19335)
		...
		public static void Register()
		{
			...
			.SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("lc"))
			.SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("lc"))
			.SetMagic(0xdbb6c0fb)
			.SetPort(port)
			.SetRPCPort(9332)
			.SetName("ltc-main")
			...
			.SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("tl"))
			.SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("tl"))
			.SetMagic(0xf1c8d2fd)
			.SetPort(port)
			.SetRPCPort(19332)
			.SetName("ltc-test")
